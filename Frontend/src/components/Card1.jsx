...
const Card1 = () => {
  return (
    <div className="group cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-rotate-1">
      <div className="relative z-10 w-[90vw] max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg text-white rounded-3xl border border-white/10 bg-gradient-to-br from-[#010101] via-[#090909] to-[#010101] shadow-2xl duration-700 backdrop-blur-xl hover:border-white/25 overflow-hidden hover:shadow-white/5 hover:shadow-3xl">
        ...
        <div className="p-6 sm:p-8 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="relative mb-6">
              ...
              />
              <div className="p-5 sm:p-6 rounded-full backdrop-blur-lg border border-white/20 bg-gradient-to-br from-black/80 to-black/60 shadow-2xl transform group-hover:rotate-12 group-hover:scale-110 transition-all duration-500 hover:shadow-white/20">
                <div className="transform group-hover:rotate-180 transition-transform duration-700">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    className="w-6 h-6 sm:w-8 sm:h-8 fill-current text-white group-hover:text-gray-200 transition-colors duration-300 drop-shadow-lg"
                  >
            ...
            <div className="space-y-1 max-w-xs sm:max-w-sm mx-auto">
              {[
                ...
                <p
                  key={idx}
                  className="text-gray-300 text-xs sm:text-sm font-semibold leading-relaxed group-hover:text-gray-200 transition-colors duration-300"
                >
                  {line}
                </p>
              ))}
